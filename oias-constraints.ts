...
function isUUID(v: unknown): v is string { return typeof v === 'string' && UUID_REGEX.test(v); }
function isHash(v: unknown): v is string { return typeof v === 'string' && SHA256_REGEX.test(v); }
function isISO(v: unknown): v is string { return typeof v === 'string' && ISO8601_REGEX.test(v); }
...
const VALID_RELATIONSHIPS: OntologyRelationship[] = [
...
export function validateKnowledgeNode(node: KnowledgeNode): Violation[] {
  const v: Violation[] = [];
...
export function validateSessionBrief(brief: SessionBrief): Violation[] {
  const v: Violation[] = [];
...
export function validateConstellationCluster(cluster: ConstellationCluster): Violation[] {
  const v: Violation[] = [];
...
export function validateRelationshipEdge(edge: RelationshipEdge): Violation[] {
  const v: Violation[] = [];
...
export function validateTranscriptIngestion(ingestion: TranscriptIngestion): Violation[] {
  const v: Violation[] = [];
...
export function validateDecisionTemplate(template: DecisionTemplate): Violation[] {
  const v: Violation[] = [];
...
export function validateDecisionReview(review: DecisionReview): Violation[] {
  const v: Violation[] = [];
...
export function validateGovernancePolicy(policy: GovernancePolicy): Violation[] {
  const v: Violation[] = [];
...
export function validateApprovalChain(chain: ApprovalChain): Violation[] {
  const v: Violation[] = [];
...
export function validateDecisionImpact(impact: DecisionImpact): Violation[] {
  const v: Violation[] = [];
...
export function validateAuditTrail(trail: AuditTrail): Violation[] {
  const v: Violation[] = [];
...
export function validateIntegrityReport(report: IntegrityReport): Violation[] {
  const v: Violation[] = [];
...
export function validateSealEvent(seal: SealEvent): Violation[] {
  const v: Violation[] = [];
...
export function validateA2AMessage(msg: A2AMessage): Violation[] {
  const v: Violation[] = [];
...
export function validateAgentIdentity(agent: AgentIdentity): Violation[] {
  const v: Violation[] = [];
...
export function validateEventClaim(claim: EventClaim): Violation[] {
  const v: Violation[] = [];
...
export function validateTaskDelegation(delegation: TaskDelegation): Violation[] {
  const v: Violation[] = [];
...
export function validateOrchestratorRouting(routing: OrchestratorRouting): Violation[] {
  const v: Violation[] = [];
