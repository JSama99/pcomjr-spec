...
export type OntologyRelationship = 'derivedFrom' | 'hasContext' | 'supportedBy' | 'references' | 'verifies' | 'recordedIn' | 'detectedIn' | 'proposes' | 'produces' | 'belongsTo' | 'relatedTo' | 'blockedBy' | 'enables' | 'supersedes' | 'contradicts';
/**
...
export type A2AIntent = 'capture-decision' | 'verify-artifact' | 'query-ledger' | 'detect-patterns' | 'propose-workflow' | 'route-intent' | 'health-check' | 'sync-state';
/**
...
export type AgentPermission = 'ledger:write' | 'ledger:read' | 'artifact:create' | 'artifact:seal' | 'decision:capture' | 'verification:execute' | 'pattern:detect' | 'workflow:propose' | 'agent:route' | 'memory:ingest' | 'memory:query';
/**
 ...
 */
export declare const OIAS_TERMINAL_TYPES: Record<string, FullArtifactType[]>;
//# sourceMappingURL=oias-types.d.ts.map