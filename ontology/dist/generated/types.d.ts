...
export declare const A2A_INTENT: readonly ["capture", "verify", "query", "pattern_detect", "stream_query"];
...
export declare const CIAS_ARTIFACT_TYPE: readonly ["beat", "loop", "stem-bundle", "mix-export", "arrangement", "flow-session", "freestyle-session", "battle-recording", "lyric-composition", "progression-signal", "comic-panel", "comic-page", "character-sheet", "location-sheet", "talonvision-export", "animation-clip", "motion-sequence", "marketplace-listing", "creator-profile", "learning-module", "curriculum"];
...
export declare const CIAS_TERMINAL_ID: readonly ["sonic-genesis", "da-cypher", "talonvision", "talonmotion", "talonfly"];
/** Lifecycle status of a decision. */
export type DecisionStatus = "draft" | "in_review" | "approved" | "rejected" | "implemented" | "verified" | "archived";
export declare const DECISION_STATUS: readonly ["draft", "in_review", "approved", "rejected", "implemented", "verified", "archived"];
...
export declare const DECISION_TYPE: readonly ["strategic", "operational", "architectural", "tactical", "governance"];
...
export declare const DIVISION: readonly ["cias", "oias"];
...
export declare const EVIDENCE_TYPE: readonly ["document", "data", "analysis", "precedent", "expert_input", "metric", "external"];
...
export declare const KNOWLEDGE_CATEGORY: readonly ["architecture", "decision", "bug-fix", "feature", "pattern", "requirement", "insight", "blocker", "milestone", "question", "action-item"];
...
export declare const MEMORY_BUS_EVENT_TYPE: readonly ["artifact.created", "artifact.updated", "artifact.verified", "artifact.sealed", "artifact.superseded", "decision.created", "decision.sealed", "decision.verified", "pattern.detected", "workflow.proposed"];
...
export declare const OIAS_ARTIFACT_TYPE: readonly ["decision", "context", "evidence", "verification", "knowledge-node", "session-brief", "transcript-ingestion", "ledger-entry", "seal-event", "audit-entry", "pattern", "workflow-proposal", "agent-task", "event-claim", "a2a-message", "constellation-cluster"];
...
export declare const OIAS_SYSTEM_ID: readonly ["artifact-memory", "decision-intelligence", "pow-ledger", "talon-agent", "talon-llm"];
...
export declare const RELATION_TYPE: readonly ["derived-from", "supersedes", "conflicts-with", "references", "implements", "validates", "influenced-by", "enables", "contradicts", "relates-to"];
...
export declare const VERIFICATION_STATUS: readonly ["unverified", "pending", "verified", "tampered", "expired"];
